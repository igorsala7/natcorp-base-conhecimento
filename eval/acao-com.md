# Cenários com contexto — 2026-08-22 03:56
...
|---|---|---|---|---|---|---|---|
| `google:gemini-3.6-flash` | 136/222 (61%) | 188/222 (85%) | 1 | 33 | 5229 | 12.13 | 4.0 |

**Gasto real desta rodada:** US$ 2.69.
...
- ❌ `google:gemini-3.6-flash` → bi_risco
...
- ❌ `google:gemini-3.6-flash` → ferias_opcoes, consultar_ferias
...
- ❌ `google:gemini-3.6-flash` → resultado_apuracao_ponto
