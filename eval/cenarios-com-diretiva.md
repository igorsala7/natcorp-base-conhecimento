# Cenários com contexto — 2026-08-19 23:52
...
|---|---|---|---|---|---|---|---|
| `google:gemini-3.5-flash` | 19/37 (51%) | 29/37 (78%) | 0 | 8 | 6227 | 14.65 | 3.9 |
| `google:gemini-3.5-flash-lite` | 22/37 (59%) | 24/37 (65%) | 4 | 9 | 6227 | 2.02 | 0.9 |
| `anthropic:claude-haiku-4-5` | 21/37 (57%) | 27/37 (73%) | 0 | 10 | 9509 | 10.21 | 2.1 |
...
- ❌ `anthropic:claude-haiku-4-5` → sesmt_procedimentos, requisicoes_exames_cand

**"traga a lista completa"** — esperado `(nenhuma)` + PERGUNTAR

- ❌ `google:gemini-3.5-flash` → pagamento_colaboradores
- ❌ `google:gemini-3.5-flash-lite` → (nenhuma)
- ❌ `anthropic:claude-haiku-4-5` → (nenhuma)
