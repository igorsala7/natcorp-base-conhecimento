...
/**
 * A Importar carrega a fila de jobs e o relatório de embeddings.
 *
 ...
 * lê duas filas e o relatório de indexação de todas as documentações — é das que mais precisavam, e estava entre as que
 * não tinham.
 *
